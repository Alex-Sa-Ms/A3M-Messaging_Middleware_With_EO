...
- The exclusive wake up is interesting. Threads that are not sure if they want to send a message, should not wait using an exclusive wake up, as the exclusive mode only signals one thread.
