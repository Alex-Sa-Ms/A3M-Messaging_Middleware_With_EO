...
There are 3 phases related to the LINK establishment:
...
| ---- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| 1    | Socket A | Sends LINK message to socket B. Changes to state "Waiting counterpart metadata".                                                                                                                            |                    |
| 2    | Socket B | Receives LINK message from A. Generates its own decision using the received metadata. Sends LINKACK message to A containing its own decision and metadata. Changes to state "Waiting counterpart decision". |                    |
| 3    | Socket A | Receives LINKACK message from B. Generates its own decision using the received metadata. Progresses to "Waiting counterpart decision".                                                                      |                    |
| 4    | Socket A | Using its own decision and B's decision present in the LINKACK message, calculates the final decision.                                                                                                      |                    |
