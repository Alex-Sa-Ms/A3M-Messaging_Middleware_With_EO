...
public class LinkNew {
     ...
     */
    public LinkNew(LinkIdentifier id, int clockId, int initialCapacity, LinkObserver observer) {
     ...
     * @param observer link observer
     */
    public LinkNew(SocketIdentifier ownerId, SocketIdentifier peerId, int clockId, int initialCapacity, LinkObserver observer) {
    ...
    public interface LinkObserver{
        void onBatchReadyEvent(LinkNew link, int batch);
    }
    ...
    boolean hasFlowControlPermission(SocketMsg msg){
    ...
    */
    ...
    void establishLink(int peerProtocolId, int peerClockId, int outCredits){
        setPeerMetadata(peerProtocolId, peerClockId, outCredits);
        establishLink();
    }
