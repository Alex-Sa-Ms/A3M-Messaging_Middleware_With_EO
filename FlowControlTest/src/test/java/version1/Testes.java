...
import version1.Receiver;
import version1.Sender;
...
public class Testes {
    ...
    public void testInitialization() throws InterruptedException {
        ...
        // test logic
        Thread.sleep(1000);
        assert sender.getCredits() == windowSize;
    ...
    public void testConsumeUnderBatchSize() throws InterruptedException {
        ...
        assert sender.getCredits() == windowSize - (windowSize * batchSizePercentage - 1);
    ...
    public void auxTestMaxCreditsToZero(int N) throws InterruptedException {
        ...
        // TODO - está a dar mal pq o batchSize é 0 e o
        //  recover depois de todas as mensagens ja estarem contabilizadas no batch.
        // TODO - windowSize = 0 implica que batchSize = 0, é necessário garantir que
        //  quando o windowSize muda que o batchSize também muda imediatamente para
        //  garantir que o fluxo de mensagens pode acontecer.
        waitUntilAllMessagesAreProcessed(receiver, sender);
